...
/**
 * Server application that also implements the IServerRemote. It creates a RemoteObject and binds its Remote interface
 * to the Registry.
 */
public class Server implements Runnable, IServerRemote {
    ...
    public void run() {
        ...
        try {
            ...
            IServerRemote remote = (IServerRemote) UnicastRemoteObject.exportObject(this, 0);
    ...
    /*
     * Implements the interface server.IServerRemote#ping(java.lang.String).
     */
    @Override
